...
import (
	...
	wrappers "github.com/Azure/AzureDefender-K8S-InClusterDefense/pkg/infra/azureauth/wrappers"
)
...
func (_m *IAzureAuthWrapper) GetSettingsFromEnvironment() (wrappers.IEnvironmentSettingsWrapper, error) {
	...
	var r0 wrappers.IEnvironmentSettingsWrapper
	if rf, ok := ret.Get(0).(func() wrappers.IEnvironmentSettingsWrapper); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(wrappers.IEnvironmentSettingsWrapper)
		}
	}
