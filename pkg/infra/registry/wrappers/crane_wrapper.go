...
// ICraneWrapper wraps cranekeychain operations
type ICraneWrapper interface {
	// Digest get image digest using image ref using cranekeychain Digest call
	Digest(ref string, opt ...crane.Option) (string, error)
}

// CraneWrapper wraps cranekeychain operations
